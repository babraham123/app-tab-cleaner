...
| `notifications` (optional) | Only requested if you turn on "Notify before closing". Shows a local system notification naming the rule and timeout. | Your operating system's notification centre. |
